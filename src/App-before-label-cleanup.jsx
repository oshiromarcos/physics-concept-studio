        ...
        <main className="main-grid">
          ...
          <section>
              ...
              <div className="card-content">
                ...
                <div className="simulation">
                  <svg viewBox="0 0 760 360" width="100%" height="100%">
                    ...
                    <text x="100" y="102" fill="#30271e" fontSize="15" fontWeight="700">
                      Cell
                    </text>

                    <text x="103" y="128" fill="#6f624d" fontSize="13">
                      positive terminal
                    </text>

                    <text x="104" y="166" fill="#6f624d" fontSize="13">
                      negative terminal
                    </text>

                    <text x="118" y="235" fill="#6f624d" fontSize="13">
                      {voltage.toFixed(1)} V
                    </text>
                    ...
                    <line
                      ...
                      strokeLinecap="round"
                    />
                    <text x="207" y="128" fill="#30271e" fontSize="16" fontWeight="800">
                      +
                    </text>
                    <text x="198" y="165" fill="#30271e" fontSize="16" fontWeight="800">
                      −
                    </text>
                    ...
                    <text x="395" y="140" fill="#6f624d" fontSize="13">
                    ...
                    <text x="391" y="205" fill="#6f624d" fontSize="13">
                      {voltage.toFixed(1)} V
                    </text>
            ...
            <div className="graph-box">
              ...
              <p className="subtitle">
                For a fixed resistance, the graph is a straight line through the origin.
              </p>
