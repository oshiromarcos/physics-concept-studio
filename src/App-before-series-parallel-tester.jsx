                ...
                <div className="simulation">
                  <svg viewBox="0 0 760 360" width="100%" height="100%">
                    ...
                    <line
                      ...
                      strokeLinecap="round"
                    />
                    <text x="210" y="116" fill="#30271e" fontSize="16" fontWeight="800">+</text>
                    <text x="210" y="178" fill="#30271e" fontSize="16" fontWeight="800">−</text>
                    ...
                    <text x="372" y="46" fill="#30271e" fontSize="15" fontWeight="700">
                      R = {resistance.toFixed(1)} Ω
                    </text>
                    <text x="468" y="145" fill="#6f624d" fontSize="13">R = {resistance.toFixed(1)} Ω</text>
                    ...
                    <path
                      ...
                      strokeDasharray="5 5"
                    />
                    <path d="M350 160 H379" fill="none" stroke="#7c6d56" strokeWidth="3" />
                    <path d="M431 160 H460" fill="none" stroke="#7c6d56" strokeWidth="3" />
                    <circle
                      cx="405"
                      cy="160"
                      r="26"
